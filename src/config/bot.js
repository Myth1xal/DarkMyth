...
export const botConfig = {
  ...
  applications: {
    ...
    defaultQuestions: [
      ...
      { question: "List your usernames on roblox and discord", required: true },
      { question: "Is there anything else you want use to know?", required: false },
    ],
